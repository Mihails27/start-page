var Fireworks = function () {
	...
	self.canvasLoop = function () {
		...
		// Launch a random firework every 100 milliseconds (adjust the interval as desired)
		if (self.dt % 100 === 0) {
	...
	self.launchRandomFirework = function () {
		var startX = rand(50, self.cw - 50);
		var startY = rand(self.ch / 2, self.ch - 50);
		var targetX = rand(50, self.cw - 50);
		var targetY = rand(50, self.ch / 2) - 50;
		self.createFireworks(startX, startY, targetX, targetY);
	};
